...
thumbnailImage: "https://www.pexels.com/photo/coronavirus-dashboard-with-map-and-statistic-6366444/"
coverImage: "https://www.pexels.com/photo/coronavirus-dashboard-with-map-and-statistic-6366444/"
---
...
Nornir returns the result as an [Aggregated Result](https://nornir.readthedocs.io/en/latest/tutorial/task_results.html) object, which is a dict-like object which we can use to iterate over to get to the required information. Let's say I want to look into one of the host/device's data, I can do that as shown below.
